...
known_destinations = {
    'Dow Chemical Plant': (-84.2275, 43.6055), # added, work destination 1
    'Midland Wastewater Treatment Center': (-84.2006, 43.6077), # added, work destination 2
    'Meijer': (-84.2432, 43.6632), # same as before
    'Walmart': (-84.2381, 43.6614), # same as before
    'Aldi': (-84.24142, 43.66200), # same as before
    'Kroger': (-84.2284, 43.6246), # same as before
    'MidMichigan Health Center': (-84.2606, 43.6351), # same as before
    'Dow Family Center': (-84.23909, 43.61011), # same as before
    'Target': (-84.24111, 43.65876) # same as before
}
...
trip_data_group3 = pd.read_excel("PovertyGroups.xlsx")
...
# first plot
plt.title("Group 4 Individual Homes on OSM")
ax.set_axis_off()
plt.show()
...
plt.title("Group 4 Homes")
plt.legend(title='Legend', bbox_to_anchor=(1.05, 1), loc='upper left')
plt.tight_layout()
ox.save_graphml(graph, 'Midland_road_network4.graphml')
plt.show()