...
average_path_lengths = {
    'EM': 12.445882528427019,
    'NM': 14.298096564531106,
    'WM': 8.411394302848576,
    'SM': 9.71136811023622,
    'CM': 14.013803824395717
}
...
# Define schools
schools = {
    'Midland': (-84.2124, 43.6202),
    'Dow': (-84.275447, 43.639836)
}

schools['Midland'] = '185279147'
schools['Dow'] = '185275807'

# Students
students_df = pd.read_excel('School1GroupsUpdated.xlsx')
...
for group_number, group_df in students_df.groupby('Group Number'):
    ...
    school_location = group_df.iloc[0]['School Location']  # e.g., 'Midland' or 'Dow'
    ...
    # Add the school node at the beginning or the end of the group_nodes list based on trip type
...
# Export to Excel
output_file_path = "TripDetails_Group1.xlsx"
